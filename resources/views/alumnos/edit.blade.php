...
@section('content')
    ...
    <div class="container">
        ...
        {!! Form::model($persona,['class'=> 'form-horizontal', 'route'=>['alumnos.update',$persona->uuid]]) !!}
        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-footer">
                ...
                <a href="{{route('alumnos.editarTutor', $persona->uuid)}}" class="btn btn-default pull-right">
                    Datos Tutor
                </a>
...
@section('jscripts')
    <script src="{{ mix('js/alumnos/editardatos.js') }}"></script>
@endsection
