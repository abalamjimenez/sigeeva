...
<div id="content">
    ...
    <tr>
        <th colspan="2" align="left">¿CUENTAS CON ALGUNA BECA, CUÁL?</th>
        <th colspan="2" align="left">¿PADECES ALGUNA ENFERMEDAD, CUÁL?</th>
    </tr>
    <tr>
        <td colspan="2" align="left">
            @if (empty($solicitud->servicio_medico))
                ND*
            @else
                {{ $solicitud->servicio_medico }}
            @endif

        </td>
        <td colspan="2" align="left">
            @if (empty($solicitud->numero_seguridad_social))
                ND*
            @else
                {{ $solicitud->numero_seguridad_social }}
            @endif
        </td>
    </tr>
    <tr>
        <th colspan="2" align="left">¿CUENTAS CON SERVICIO MEDICO, CUÁL?</th>
        <th colspan="2" align="left">NO. DE SEGURIDAD SOCIAL</th>
    </tr>
    <tr>
    ...
    <tr>
        <th align="left">Escuela procedencia</th>
