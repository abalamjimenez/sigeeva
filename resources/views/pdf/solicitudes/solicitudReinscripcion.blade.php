...
<header>
    ...
    <div class="titulo">
        CÉDULA DE REINSCRIPCIÓN<br>
        {{ $periodoEscolar->descripcion }}<br>
...
<div id="content">
    ...
    <h4 style="border-bottom:1px solid #C3C3C3;margin-bottom:.5em;margin-top:1em">DATOS DEL ALUMNO</h4>
    ...
    <h4 style="border-bottom:1px solid #C3C3C3;margin-bottom:.5em;margin-top:1em">DATOS ACADÉMICOS</h4>
    ...
    <h4 style="border-bottom:1px solid #C3C3C3;margin-bottom:.5em;margin-top:1em">DATOS DEL PADRE O TUTOR</h4>
    ...
    <h4 style="border-bottom:1px solid #C3C3C3; margin-bottom:.5em;margin-top:1em">DATOS LABORALES DEL PADRE O TUTOR</h4>
