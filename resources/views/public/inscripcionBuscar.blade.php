                    ...
                    <div class="card-deck">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="GET" action="{{ route('public.inscripcionCargar') }}" accept-charset="UTF-8" class="form-horizontal">

                                    <div class="input-group mb-3">
                                        <input placeholder="curp" class="form-control required" id="curp" name="curp" value="{{ old('curp') }}" type="text" autofocus>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text text-justify">
                                    Ingresa tu CURP y presiona enviar para comenzar tu proceso de inscripción.
                                </p>
                            </div>
                        </div>
                    </div>
