Mostrando {{collect($solicitudesEnviadas->items())->count()}} registros de un total de {{$solicitudesEnviadas->total()}}
...
<tbody>
    @foreach($solicitudesEnviadas as $registro)
        <tr>
            <td>
                <div class="dropdown position-static show">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <!--
                        <a class="dropdown-item" href="{{ route('solicitudes.procesar',$registro->uuid) }}">
                            Procesar solicitud
                        </a>
                        !-->
                    </div>
